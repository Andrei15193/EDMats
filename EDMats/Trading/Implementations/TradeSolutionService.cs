...
namespace EDMats.Trading.Implementations
{
    public class TradeSolutionService : ITradeSolutionService
    {
        ...
        public TradeSolution TryFindSolution(IEnumerable<MaterialQuantity> desiredMaterialQuantities, IEnumerable<MaterialQuantity> availableMaterialQuantities, IEnumerable<AllowedTrade> allowedTrades)
        {
            ...
            return _TryFindSolution(desiredMaterialsData);
        }

        private TradeSolution _TryFindSolution(IEnumerable<DesiredMaterialInfo> desiredMaterialsData)
        {
