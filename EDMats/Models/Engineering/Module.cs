        ...
        {
            {
                ...
                CoreInternals = new ModuleType("ci", "Core Internals", modules);
                {
                    ...
                    Array.Sort(blueprints, (left, right) => string.Compare(left.Name, right.Name, StringComparison.OrdinalIgnoreCase));
                ...
                Array.Sort(modules, (left, right) => string.Compare(left.Name, right.Name, StringComparison.OrdinalIgnoreCase));
            }
                ...
                }
                {
                    ...
                    blueprints[0] = new Blueprint(
                        ...
                        new[]
                        {
                            new BlueprintGradeRequirements(BlueprintGrade.Grade1, new[] { new MaterialQuantity(Material.Iron, 1) }),
                            new BlueprintGradeRequirements(BlueprintGrade.Grade2, new[] { new MaterialQuantity(Material.ConductiveComponents, 1), new MaterialQuantity(Material.Iron, 1) }),
                            new BlueprintGradeRequirements(BlueprintGrade.Grade3, new[] { new MaterialQuantity(Material.ConductiveComponents, 1), new MaterialQuantity(Material.FocusCrystals, 1), new MaterialQuantity(Material.Iron, 1) }),
                    ...
                    blueprints[4] = new Blueprint(
                        ...
                        {
                            new BlueprintGradeRequirements(BlueprintGrade.Grade1, new[] { new MaterialQuantity(Material.Iron, 1) }),
                            new BlueprintGradeRequirements(BlueprintGrade.Grade2, new[] { new MaterialQuantity(Material.Germanium, 1), new MaterialQuantity(Material.HeatConductionWiring, 1) }),
                            new BlueprintGradeRequirements(BlueprintGrade.Grade3, new[] { new MaterialQuantity(Material.FocusCrystals, 1), new MaterialQuantity(Material.HeatConductionWiring, 1), new MaterialQuantity(Material.HeatDispersionPlate, 1) }),
