        ...
        {
            {
                ...
                Raw = new MaterialType("Raw", categories);
                {
                    ...
                    Array.Sort(materials, (left, right) => string.Compare(left.Name, right.Name, StringComparison.OrdinalIgnoreCase));
                }
                {
                    var materials = new Material[4];
                ...
                Array.Sort(categories, (left, right) => string.Compare(left.Name, right.Name, StringComparison.OrdinalIgnoreCase));
            }
